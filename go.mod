...
replace (
	...
	// TODO: remove this when upstream got merged https://github.com/crypto-org-chain/ethermint/pull/151
	github.com/tharsis/ethermint => github.com/jayt106/ethermint v0.11.2-db-options
